...
-- Started on 2011-09-30 13:51:32 MSK
...
--
-- TOC entry 1869 (class 1262 OID 16385)
-- Name: tarif; Type: DATABASE; Schema: -; Owner: tarif
--

CREATE DATABASE tarif WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'ru_RU.UTF-8' LC_CTYPE = 'ru_RU.UTF-8';


ALTER DATABASE tarif OWNER TO tarif;
...
SELECT pg_catalog.setval('blacklist_id_seq', 8, true);
...
SELECT pg_catalog.setval('seanses_id_seq', 8, true);
...
SELECT pg_catalog.setval('whitelist_id_seq', 20, true);
...
INSERT INTO blacklist (id, host, datebegin, dateend) VALUES (3, 'kavkazcenter.com', NULL, NULL);
INSERT INTO blacklist (id, host, datebegin, dateend) VALUES (6, 'zzz.ru', NULL, NULL);
INSERT INTO blacklist (id, host, datebegin, dateend) VALUES (8, 'mail.ru', NULL, NULL);
...
INSERT INTO seanses (id, deviceid, accesstime, servicetypeid) VALUES (8, 1, '2011-09-26 17:35:08', 1);
...
INSERT INTO whitelist (id, host, datebegin, dateend) VALUES (1, 'yandex.ru', NULL, NULL);
INSERT INTO whitelist (id, host, datebegin, dateend) VALUES (2, 'gov.spb.ru', NULL, NULL);
INSERT INTO whitelist (id, host, datebegin, dateend) VALUES (3, 'gu.spb.ru', NULL, NULL);
INSERT INTO whitelist (id, host, datebegin, dateend) VALUES (16, 'example.com', NULL, NULL);
INSERT INTO whitelist (id, host, datebegin, dateend) VALUES (19, 'google.com', NULL, NULL);
INSERT INTO whitelist (id, host, datebegin, dateend) VALUES (20, 'gosuslugi.ru', NULL, NULL);
...
-- Completed on 2011-09-30 13:51:32 MSK
